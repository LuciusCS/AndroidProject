...
public class BleServiceTest extends Service {
...
//    private final UUID CHARACTERISTIC_NOTIFY = UUID.fromString("6e400003-b5a3-f393-e0a9-e50e24dcca9e");
    ...
    //用于绑定服务
    private final IBinder mbinder = new BleServiceTest.LocalBinder();


    public class LocalBinder extends Binder {

        public BleServiceTest getService() {
            return BleServiceTest.this;
        }
