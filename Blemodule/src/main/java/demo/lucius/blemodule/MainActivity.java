...
import demo.lucius.blemodule.moudle.observe.Observer;
import demo.lucius.blemodule.moudle.observe.ProtocolObservable;
import demo.lucius.blemodule.moudle.service.BleService;
...
//                    LogUtils.\\("++++++++++++++++++++");
        ...
        public void onScanResult(int callbackType, ScanResult result) {
            ...
            if (null != result.getDevice().getName() && result.getDevice().getName().equals("ES_CRBK")) {
