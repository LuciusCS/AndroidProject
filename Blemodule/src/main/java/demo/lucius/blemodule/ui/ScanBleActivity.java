package demo.lucius.blemodule.ui;
...
import demo.lucius.blemodule.databinding.ActivityScanBleBinding;
...
public class ScanBleActivity extends AppCompatActivity {
    ...
    //用于表示DataBinding
    private ActivityScanBleBinding scanBleBinding;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        scanBleBinding = DataBindingUtil.setContentView(this, R.layout.activity_scan_ble);
        initBle();
        startDiscover();
        //注册广播
